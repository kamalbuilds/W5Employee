...
export const MAP_STATE_TO_TYPE = {
  INITIAL: {
    userDetails: {
      ...
      bio: "A passionate Blockchain developer. I like to build cutting edge application with latest technoglogies.",
    },
    projects: [
      {
        projectTitle: "",
...
export const DUMMY_DATA = {
  educationTitle: "Btech EE",
  projectTitle: "Project Title",
  projectDescription:
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit.\n \t-sed do eiusmod tempor incididunt. \n \t-ut labore et dolore magna aliqua.",
  skill: ["JavaScript", "Reactjs"],
  socialName: "GitHub",
  socialLink: "https://github.com/kamalbuilds",
};
